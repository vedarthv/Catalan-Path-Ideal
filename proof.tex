...
We also thank Christian Stump for pointing to their work~\cite{ESS}, see Remark~\ref{rem:stump}.
...
We have established that
 ...
 \begin{remark}\label{rem:stump}
   The basis $B$ in Equation~\eqref{Eq:basis1} is the same as the standard simplicial complex obtained in~\cite{ESS}. This means there are some 
   matroid $M$ with the property that their vanishing ideal $I(M)$ will lead to the same basis of the quotient as in Equation~\eqref{Eq:basis1}. An interesting question is to find,
