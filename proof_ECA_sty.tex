...
\usepackage{amsmath,amsthm,amsfonts,amssymb,amscd,cite,mathrsfs,graphicx,url}
\usepackage{latexsym}
\usepackage{enumitem}
\usepackage{thmtools}
...
\fancypagestyle{mypagestyle}{%
  ...
  \fancyhead[OC]{Nantel Bergeron and Xavier Mootoo}% Author on Odd page, Centred
  \fancyfoot[C]{{\it ECA}  {\bf x:x} (xxxx) Article \#SxRx\hfill\arabic{page}}%
  \renewcommand{\headrulewidth}{.4pt}% Header rule of .4pt
}
\pagestyle{mypagestyle}
\usepackage[mathlines,running]{lineno}
%\linenumbers
%-------------------------your commands
...
@book{iva,
 ...
 PUBLISHER = {Springer-Verlag, New York},
  ...
  @unpublished{ESS,
   AUTHOR = {Engstr\"om, Alexander  and Sanyal, Raman and  Stump, Christian},
  TITLE = {{Standard complexes of matroids and lattice paths}},
  YEAR = {2019},
  NOTE={arXiv:1911.12290},
  }
...
%\includegraphics[width=2.8cm]{ECA.pdf}
\footnotesize{ {\bf Enumerative Combinatorics and Applications} \\ \underline{ecajournal.haifa.ac.il}}
\end{minipage}
\hfill
\begin{minipage}[t]{5.4cm}
\normalsize {\it ECA}  {\bf X:X} (xxxx) Article \#SxRx
\end{minipage}}
\vskip36pt
...
\noindent {\footnotesize {\bf Received}: March 16, 2022},
...
\noindent{\bf Keywords}: Gr\"obner Basis; Catalan Numbers; Path Enumeration\\

\noindent{\bf 2020 Mathematics Subject Classification}: 05E40; 13P10
