...
\fancypagestyle{mypagestyle}{%
  ...
  \fancyhead[OC]{Nantel Bergeron, Xavier Mootoo and Vedarth Vyas}% Author on Odd page, Centred
...
For each $v \in U_{\alpha, 1}$, we have $\ell_1(v) =\ell_1(\alpha) - 1$ and let $k$ be the unique position, where $v_k=\textnormal{\texttt{0}}$ and $\alpha_k=\textnormal{\texttt{1}}$.
